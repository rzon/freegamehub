! function(e, t) {
            ...
            switch (c && "object" === _typeof(c) && "function" == typeof c.toJSON && (c = c.toJSON(e)), _typeof(c = "function" == typeof rep ? rep.call(t, e, c) : c)) {
                ...
                case "object":
                    ...
                    if (rep && "object" === _typeof(rep))
                        for (o = rep.length, r = 0; r < o; r += 1) "string" == typeof rep[r] && (i = str(n = rep[r], c)) && s.push(quote(n) + (gap ? ": " : ":") + i);
                    else
                        for (n in c) Object.prototype.hasOwnProperty.call(c, n) && (i = str(n, c)) && s.push(quote(n) + (gap ? ": " : ":") + i);
                    return i = 0 === s.length ? "{}" : gap ? "{\n" + gap + s.join(",\n" + gap) + "\n" + a + "}" : "{" + s.join(",") + "}", gap = a, i
            }
        }
        "function" != typeof Date.prototype.toJSON && (Date.prototype.toJSON = function() {
            ...
            function walk(e, t) {
                ...
                if (i && "object" === _typeof(i))
                    for (r in i) Object.prototype.hasOwnProperty.call(i, r) && (void 0 !== (n = walk(i, r)) ? i[r] = n : delete i[r]);
    ...
    function $a(e, t) {
        var r = e.charAt(0),
            t = t.split(r);
        return r === e ? t : t[(e = parseInt(e.substring(1), 10)) < 0 ? t.length + e : e - 1]
    }

    function _a(e, t) {
        for (var r, n, i = e.charAt(0), o = t.split("&"), s = [], a = {}, c = e.substring(1), p = 0, u = o.length; p < u; p++)
            if ("" !== (s = (s = o[p].match(/(.*?)=(.*)/)) || [o[p], o[p], ""])[1].replace(/\s/g, "")) {
                if (s[2] = (n = s[2] || "", _.decodeURIComponent(n.replace(/\+/g, " "))), c === s[1]) return s[2];
                (r = s[1].match(/(.*)\[([0-9]+)\]/)) ? (a[r[1]] = a[r[1]] || [], a[r[1]][r[2]] = s[2]) : a[s[1]] = s[2]
            }
        return i === e ? a : a[c]
    }
    _.each = function(e, t, r) {
        ...
        return e.getFullYear() + "-" + t(e.getMonth() + 1) + "-" + t(e.getDate()) + " " + t(e.getHours()) + ":" + t(e.getMinutes()) + ":" + t(e.getSeconds()) + "." + ((r = e.getMilliseconds()) < 10 ? "00" + r : r < 100 ? "0" + r : r);
        var r
        ...
        (_.check.isObject(r) || _.check.isArray(r)) && _.each(r, function(e, t) {
            _.check.isObject(e) || _.check.isArray(e) ? _.searchObjDate(r[t]) : _.check.isDate(e) && (r[t] = _.formatDate(e))
        })
    }, _.check = {
        ...
        var e = (e = String(screen.height * screen.width)) && /\d{5,}/.test(e) ? e.toString(16) : String(31242 * Math.random()).replace(".", "").slice(0, 8),
            e = za() + "-" + Math.random().toString(16).replace(".", "") + "-" + function() {
                ...
                for (e = 0; e < r.length; e++) t = r.charCodeAt(e), i.unshift(255 & t), 4 <= i.length && (n = o(n, i), i = []);
        ...
        if (e = e.toString(), n = t.match(/^mailto:([^\/].+)/)) r.protocol = "mailto", r.email = n[1];
        else {
            if ((n = (t = (n = t.match(/(.*?)\/#\!(.*)/)) ? n[1] + n[2] : t).match(/(.*?)#(.*)/)) && (r.hash = n[2], t = n[1]), r.hash && e.match(/^#/)) return _a(e, r.hash);
            if ((n = t.match(/(.*?)\?(.*)/)) && (r.query = n[2], t = n[1]), r.query && e.match(/^\?/)) return _a(e, r.query);
            if ((n = t.match(/(.*?)\:?\/\/(.*)/)) && (r.protocol = n[1].toLowerCase(), t = n[2]), (n = t.match(/(.*?)(\/.*)/)) && (r.path = n[2], t = n[1]), r.path = (r.path || "").replace(/^([^\/])/, "/$1").replace(/\/$/, ""), (e = e.match(/^[\-0-9]+$/) ? e.replace(/^([^\/])/, "/$1") : e).match(/^\//)) return $a(e, r.path.substring(1));
            if ((n = (n = $a("/-1", r.path.substring(1))) && n.match(/(.*?)\.(.*)/)) && (r.file = n[0], r.filename = n[1], r.fileext = n[2]), (n = t.match(/(.*)\:([0-9]+)$/)) && (r.port = n[2], t = n[1]), (n = t.match(/(.*?)@(.*)/)) && (r.auth = n[1], t = n[2]), r.auth && (n = r.auth.match(/(.*)\:(.*)/), r.user = n ? n[1] : r.auth, r.pass = n ? n[2] : void 0), r.hostname = t.toLowerCase(), "." === e.charAt(0)) return $a(e, r.hostname);
            Ya() && (n = r.hostname.match(Ya())) && (r.tld = n[3], r.domain = n[2] ? n[2] + "." + n[3] : void 0, r.sub = n[1] || void 0);
            var n = r.port ? ":" + r.port : "";
            r.protocol = r.protocol || window.location.protocol.replace(":", ""), r.port = r.port || ("https" === r.protocol ? "443" : "80"), r.protocol = r.protocol || ("443" === r.port ? "https" : "http"), r.basic = r.protocol + "://" + r.hostname + n
        }
        ...
        for (var t, r = "", n = t = 0, i = (e = (e + "").replace(/\r\n/g, "\n").replace(/\r/g, "\n")).length, o = 0; o < i; o++) {
            var s = e.charCodeAt(o),
                a = null;
            s < 128 ? t++ : a = 127 < s && s < 2048 ? String.fromCharCode(s >> 6 | 192, 63 & s | 128) : String.fromCharCode(s >> 12 | 224, s >> 6 & 63 | 128, 63 & s | 128), null !== a && (n < t && (r += e.substring(n, t)), r += a, n = t = o + 1)
        }
        ...
        var t, r, n, i, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
            ...
            p = [];
        if (!e) return e;
        for (e = _.utf8Encode(e); t = (i = e.charCodeAt(s++) << 16 | e.charCodeAt(s++) << 8 | e.charCodeAt(s++)) >> 12 & 63, r = i >> 6 & 63, n = 63 & i, p[a++] = o.charAt(i >> 18 & 63) + o.charAt(t) + o.charAt(r) + o.charAt(n), s < e.length;);
        ...
        set: function(e, t, r, n, i) {
            var o, s = "",
                a = "",
                c = "";
            r = null === r ? 73e3 : r, n && (s = (o = _.url("domain", location.href)) ? "; domain=." + o : ""), r && (o = new Date, "s" === String(r).slice(-1) ? o.setTime(o.getTime() + 1e3 * Number(String(r).slice(0, -1))) : o.setTime(o.getTime() + 24 * r * 60 * 60 * 1e3), a = "; expires=" + o.toGMTString()), i && (c = "; secure");
        ...
        isSupported: function() {
            ...
            try {
                ...
                _.localStorage.set(e, r), _.localStorage.get(e) !== r && (t = !1), _.localStorage.remove(e)
            } catch (e) {
                t = !1
            }
            return t
        ...
        browser: function() {
            ...
            try {
                var t, r, n = navigator.userAgent.toLowerCase(),
                    i = [];
            ...
            return _createClass(e, null, [{
                ...
                value: function(e) {
                    return _.check.isObject(e) && _.each(e, function(e, t) {
                        _.check.isString(e) || _.check.isNumber(e) || _.check.isDate(e) || _.check.isBoolean(e) || _.check.isArray(e) || Log.w("您的数据-", t, e, "-格式不满足要求，可能无法正确入库. 属性值只支持 String, Number, Date, Boolean, Array")
                    }), e
                }
            }, {
                ...
                value: function(e) {
                    var r = !0;
                    return _.each(e, function(e, t) {
                        KEY_NAME_MATCH_REGEX.test(t) || (Log.w("不合法的 KEY 值: " + t), r = !1)
                    }), r
                }
            }, {
                key: "event",
    ...
    ThinkingDataAnalyticsLib.prototype.trackLink = function(e, r, n) {
        var i, o, s = this;
        this._isCollectData() && (i = this._getConfig("strict"), PropertyChecker.properties(n) || !i ? e && _.check.isObject(e) && (o = [], _.each(e, function(e, r) {
            ...
            var t;
            null !== e && ((t = _.extend({}, _.info.pageProperties(), n))["#element_type"] = e.nodeName.toLowerCase(), _.check.isUndefined(t.name) && (t.name = e.getAttribute("td-name") || e.innerHTML || e.value || "未获取标识"), e.addEventListener("click", function() {
                s._sendRequest({
                    type: "track",
                    event: r,
        ...
        return t.zoneOffset = e, t.toEventPresetProperties = function() {
            return {
                "#os": t.os,
        ...
        var r;
        this._isCollectData() && (!PropertyChecker.propertyName(e) && this._getConfig("strict") || ((r = {})[e] = 0, this._sendRequest({
            type: "user_unset",
            properties: r
        }, t)))
    }, ThinkingDataAnalyticsLib.prototype.userAdd = function(e, t) {
        var r;
        this._isCollectData() && (_.check.isString(e) && (r = e, (e = {})[r] = 1), PropertyChecker.propertiesMust(e) && (! function(e) {
            for (var t in e)
        ...
        var n, i, o, s, a, c = _.check.isUndefined(e.time) || !_.check.isDate(e.time) ? new Date : e.time,
            p = {
                data: [{
                    "#type": e.type,
                    "#time": _.formatDate(c),
        ...
        if (this.persistence.getAccountId() && (p.data[0]["#account_id"] = this.persistence.getAccountId()), "track" === e.type || "track_update" === e.type || "track_overwrite" === e.type ? (p.data[0]["#event_name"] = e.event, "track_update" === e.type || "track_overwrite" === e.type ? p.data[0]["#event_id"] = e.extraId : e.firstCheckId && (p.data[0]["#first_check_id"] = e.firstCheckId), p.data[0].properties = _.extend({}, {
                "#device_id": this.persistence.getDeviceId(),
                "#zone_offset": 0 - c.getTimezoneOffset() / 60
            }, _.info.properties(), this.getSuperProperties(), this.dynamicProperties ? this.dynamicProperties() : {}, this.getPageProperty()), c = this.persistence.removeEventTimer(e.event), _.check.isUndefined(c) || (c = (new Date).getTime() - c, p.data[0].properties["#duration"] = parseFloat((c / 1e3).toFixed(3)))) : p.data[0].properties = {}, _.check.isObject(e.properties) && !_.check.isEmptyObject(e.properties) && _.extend(p.data[0].properties, e.properties), _.searchObjDate(p.data[0]), p["#app_id"] = this._getConfig("appId"), Log.i(p), this._getConfig("useAppTrack")) {
            e = window.ThinkingData_APP_JS_Bridge || {};
            if ("object" === _typeof(e) && e.thinkingdata_track) return e.thinkingdata_track(JSON.stringify(p)), void("function" == typeof t && t());
            if (/td-sdk-ios/.test(navigator.userAgent) && !window.MSStream) {
                e = document.createElement("iframe");
                return e.setAttribute("src", "thinkinganalytics://trackEvent?event=" + _.encodeURIComponent(JSON.stringify(p))), document.documentElement.appendChild(e), e.parentNode.removeChild(e), e = null, void("function" == typeof t && t())
            }
        }
        r && (p.data[0]["#uuid"] = _.UUIDv4()), this._isDebug() ? (i = "&data=" + _.encodeURIComponent(JSON.stringify(p.data[0])) + "&source=client&deviceId=" + this.getDeviceId() + "&appid=" + this._getConfig("appId") + "&version=" + Config.LIB_VERSION, "debug_only" === this._getConfig("mode") && (i += "&dryRun=1")) : (p = JSON.stringify(p), n = _.base64Encode(p), s = "crc=" + _.hashCode(n), i = "&data=" + _.encodeURIComponent(n) + "&ext=" + _.encodeURIComponent(s) + "&version=" + Config.LIB_VERSION), "ajax" === this._getConfig("send_method") ? (o = null, o = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"), s = this._getConfig("serverUrl"), o.open("post", s, !0), o.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), a = this, o.onreadystatechange = function() {
            var e;
            4 === o.readyState && 200 === o.status && (t && t(), a._isDebug() && (0 !== (e = JSON.parse(o.response)).errorLevel ? Log.w(e) : Log.i(e)))
        }, o.send(i)) : this._sendRequestWithImage(i, t), r && void 0 !== ("undefined" == typeof navigator ? "undefined" : _typeof(navigator)) && navigator.sendBeacon && ((r = new FormData).append("data", n), navigator.sendBeacon(this._getConfig("serverUrl"), r))
        ...
        var n = (-1 !== this._getConfig("serverUrl").indexOf("?") ? this._getConfig("serverUrl") : this._getConfig("serverUrl") + "?") + e,
            e = document.createElement("img");
        e.callback = t, setTimeout(r, this._getConfig("dataSendTimeout"), e), e.onload = function() {
        ...
        this._isCollectData() && (PropertyChecker.event(e) && PropertyChecker.properties(t) || !this._getConfig("strict")) && this._sendRequest({
            type: "track",
            event: e,
        ...
        (PropertyChecker.event(e) && PropertyChecker.properties(t) || !this._getConfig("strict")) && this._sendRequest({
            type: "track",
            event: e,
            time: _.check.isDate(r) ? r : new Date,
            properties: t
        ...
        this._isCollectData() && (PropertyChecker.propertiesMust(e) || !this._getConfig("strict") ? this.persistence.setSuperProperties(e) : Log.w("setSuperProperties 参数不合法"))
        ...
        this._isCollectData() && ("string" == typeof e && "autoTrack" === e ? this._sendRequest({
            type: "track",
            event: "ta_pageview",
        ...
        var t;
        _.check.isUndefined(this.config) ? (this.config = {}, this.currentProps = this.currentProps || {}, this._setConfig(_.extend({}, DEFAULT_CONFIG, e)), this.persistence = new ThinkingDataPersistence(this.config), Log.showLog = this._getConfig("showLog"), "image" !== (t = this._getConfig("send_method")) && "ajax" !== t && "beacon" !== t && (Log.i("send_method", t, "is not supported. Changed to image as default value"), this._setConfig({
            send_method: "image"
        })), this._isDebug() ? this._setConfig({
        ...
        t.persistenceEnabled && (t.persistencePrefix = t.persistencePrefix + "_" + e), r.init(t), this[e] = r
