window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function(t, i) {
    ...
    class s {
        ...
        static playVideo(t, e, a) {
            this._instance ? (i.stage.event(s.EVENT_AD_VIDEO_PLAY), 
            this._instance.playVideo(i.Handler.create(null, function() {
        ...
        static showInsertAd(t, i) {
            this._instance ? this._instance.showInsertAd ? this._instance.showInsertAd(t, i) : this._instance.showFullScreenAD && this._instance.showFullScreenAD(t, i) : (t && t.runWith("not in wx"), 
