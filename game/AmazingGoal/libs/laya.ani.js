! function(t, e, st) {
    ...
    var i = st.static,
        ...
        Ct = laya.utils.Byte,
        s = (laya.Const, laya.events.Event, laya.events.EventDispatcher),
        ...
        rt = (laya.utils.RunDriver, laya.display.Sprite),
        d = laya.utils.Stat,
        wt = laya.resource.Texture,
        y = (laya.utils.Timer, laya.net.URL, laya.utils.Utils),
        kt = function() {
            function t() {
            ...
            return a(t, "laya.ani.bone.TfConstraint"), t.prototype.apply = function() {
                for (var t, e = this.target.resultMatrix.a, i = this.target.resultMatrix.b, a = this.target.resultMatrix.c, s = this.target.resultMatrix.d, r = 0, n = this._bones.length; r < n; r++) {
                    ...
                    if (this.translateMix && (this._temp[0] = this._data.offsetX, this._temp[1] = this._data.offsetY, this.target.localToWorld(this._temp), t.resultMatrix.tx += (this._temp[0] - t.resultMatrix.tx) * this.translateMix, t.resultMatrix.ty += (this._temp[1] - t.resultMatrix.ty) * this.translateMix, t.updateChild()), 0 < this.scaleMix) {
                        ...
                        t.resultMatrix.a *= m, t.resultMatrix.c *= m, d = Math.sqrt(t.resultMatrix.b * t.resultMatrix.b + t.resultMatrix.d * t.resultMatrix.d), f = Math.sqrt(i * i + s * s), m = 1e-5 < d ? (d + (f - d + this._data.offsetScaleY) * this.scaleMix) / d : 0, t.resultMatrix.b *= m, t.resultMatrix.d *= m;
                    }
                    if (0 < this.shearMix) {
                ...
                for (v._templet._anis.length = l, i = 0; i < l; i++) {
                    ...
                    for (a = o.totalKeyframeDatasLength = 0; a < c; a++) {
                        ...
                        for (s = 0, r = _.keyFrame.length = d; s < r; s++) {
                            (f = _.keyFrame[s] = {}).startTime = t.getFloat32(), m && (m.duration = f.startTime - m.startTime), f.dData = new Float32Array(n), f.nextData = new Float32Array(n);
                ...
                for (0 < f && (t._publicExtData = i.slice(f, i.byteLength)), t._useParent = !!e.getUint8(), t._anis.length = p, a = 0; a < p; a++) {
                    ...
                    for (s = y.totalKeyframeDatasLength = 0; s < g; s++) {
                        ...
                        if (y.totalKeyframeDatasLength += I, 0 === D.lerpType || 1 === D.lerpType)
                            for (D.interpolationMethod = [], D.interpolationMethod.length = I, r = 0; r < I; r++) D.interpolationMethod[r] = P.interpolation[m.getUint8()];
            ...
            return t.apply = function() {
                ...
                if (0 != r) {
                    ...
                    var d = e.resultTransform.x,
                        ...
                        v = t.resultMatrix.d,
                        M = Math.abs(l - o) <= 1e-4;
                    y = M ? (m = x * d + g * (f = e.resultTransform.y) + t.resultMatrix.tx, D * d + v * f + t.resultMatrix.ty) : (f = 0, m = x * d + t.resultMatrix.tx, D * d + t.resultMatrix.ty), this.isDebug && (this._sp || (this._sp = new rt(), st.stage.addChild(this._sp)), this._sp.graphics.clear(), this._sp.graphics.drawCircle(i, a, 15, "#ffff00"), this._sp.graphics.drawCircle(m, y, 15, "#ff00ff")), t.setRotation(Math.atan2(y - t.resultMatrix.ty, m - t.resultMatrix.tx));
                    var I = t.parentBone;
                    ...
                    if (M) {
                        ...
                        B < -1 ? B = -1 : 1 < B && (B = 1), U = Math.acos(B) * s, x = w + k * B, g = k * Math.sin(U), P = Math.atan2(S * x - T * g, T * x + S * g);
                    } else {
                        var L = (x = l * k) * x,
                            R = (g = o * k) * g,
                            E = T * T + S * S,
                        ...
                        var z = 0,
                            ...
                            j = 0,
                            J = 0;
                        $ < (v = (A = w + x) * A) && (Q = 0, $ = v, j = A), (v = (A = w - x) * A) < q && (z = Math.PI, q = v, H = A);
                        var tt = Math.acos(-x * w / (L - R));
                        (v = (A = x * Math.cos(tt) + w) * A + (N = g * Math.sin(tt)) * N) < q && (z = tt, q = v, H = A, Z = N), $ < v && (Q = tt, $ = v, j = A, J = N), U = E <= (q + $) / 2 ? (P = V - Math.atan2(Z * s, H), z * s) : (P = V - Math.atan2(J * s, j), Q * s);
                    }
                    var et = Math.atan2(f, d) * p,
                        it = t.resultTransform.skX;
                    180 < (P = (P - et) * at.radDeg + c - it) ? P -= 360 : P < -180 && (P += 360), t.resultTransform.x = n, t.resultTransform.y = h, t.resultTransform.skX = t.resultTransform.skY = it + P * r, it = e.resultTransform.skX, 180 < (U = ((U + et) * at.radDeg - 0) * p + _ - (it %= 360)) ? U -= 360 : U < -180 && (U += 360), e.resultTransform.x = d, e.resultTransform.y = f, e.resultTransform.skX = e.resultTransform.skY = e.resultTransform.skY + U * r, t.update();
                }
                ...
                if (0 != r) {
                    ...
                    n = d, h = f, this.isDebug && (this._sp || (this._sp = new rt(), st.stage.addChild(this._sp)), this._sp.graphics.clear(), this._sp.graphics.drawCircle(_, p, 15, "#ff00ff"), this._sp.graphics.drawCircle(i, a, 15, "#ffff00"), this._sp.graphics.drawCircle(n, h, 15, "#ff00ff"));
                    var C, F;
        ...
        Et = function() {
            ...
            return e.createTexture = function(t) {
                return this.texture || (this.texture = new wt(t.bitmap, this.uvs), this.uvs[0] > this.uvs[4] && this.uvs[1] > this.uvs[5] ? (this.texture.width = t.height, this.texture.height = t.width, this.texture.offsetX = -t.offsetX, this.texture.offsetY = -t.offsetY, this.texture.sourceWidth = t.sourceHeight, this.texture.sourceHeight = t.sourceWidth) : (this.texture.width = t.width, this.texture.height = t.height, this.texture.offsetX = -t.offsetX, this.texture.offsetY = -t.offsetY, this.texture.sourceWidth = t.sourceWidth, this.texture.sourceHeight = t.sourceHeight), m.isWebGL || this.uvs[1] > this.uvs[5] && (this.texture.offsetY = this.texture.sourceHeight - this.texture.height - this.texture.offsetY)), this.texture;
            }, e.destory = function() {
            ...
            return t.showSlotData = function(t, e) {
                        ...
                        case 0:
                            if (t) {
                                ...
                                if (this._parentMatrix) {
                                    ...
                                    if (n) {
                                        var l;
                                        if (Ft.mul(n, this._parentMatrix, Ft.TEMP), l = i ? (null == this._resultMatrix && (this._resultMatrix = new Ft()), this._resultMatrix) : D._tempResultMatrix, !m.isWebGL && this.currDisplayData.uvs || m.isWebGL && this._diyTexture && this.currDisplayData.uvs) {
                                            var o = D._tempMatrix;
                            ...
                            break;
                        case 1:
                            if (null == (s = i ? (null == this._skinSprite && (this._skinSprite = D.createSkinMesh()), this._skinSprite) : D.createSkinMesh())) return;
                            var u;
                            if (null == this.currDisplayData.bones) {
                                ...
                                u = this.currDisplayData.triangles, this.deformData && (i || (this._mVerticleArr = this.getSaveVerticle(this._mVerticleArr))), s.init2(r, u, this._mVerticleArr, c);
                                var p, d = this.getDisplayMatrix();
                                if (this._parentMatrix)
                                    if (d) Ft.mul(d, this._parentMatrix, Ft.TEMP), p = i ? (null == this._resultMatrix && (this._resultMatrix = new Ft()), this._resultMatrix) : D._tempResultMatrix, Ft.TEMP.copyTo(p), i || (p = this.getSaveMatrix(p)), s.transform = p;
                ...
                if (D._tempVerticleArr.length = 0, h = D._tempVerticleArr, this.deformData && 0 < this.deformData.length) {
                    ...
                    for (y = 0, x = s.length; y < x;) {
                        for (_ = s[y++] + y, c = u = 0; y < _; y++) n = t[s[y]], p = l[f] + this.deformData[g++], d = l[f + 1] + this.deformData[g++], m = l[f + 2], u += (p * n.a + d * n.c + n.tx) * m, c += (p * n.b + d * n.d + n.ty) * m, f += 3;
                        h.push(u, c);
                    }
                } else
                    for (y = 0, x = s.length; y < x;) {
                        for (_ = s[y++] + y, c = u = 0; y < _; y++) n = t[s[y]], p = l[f], d = l[f + 1], m = l[f + 2], u += (p * n.a + d * n.c + n.tx) * m, c += (p * n.b + d * n.d + n.ty) * m, f += 3;
                        h.push(u, c);
                    }
                this._mVerticleArr = h, r = o, this._mVerticleArr = this.getSaveVerticle(this._mVerticleArr), e.init2(a, r, this._mVerticleArr, i);
            ...
            return t.apply = function(t, e) {
                    ...
                    for (f = 0, T = 3; f < c; f++, T += 3) {
                        ...
                        if (I = g, b = D, s) {
                            var w = y.resultMatrix.a,
                                ...
                                L = NaN,
                                R = NaN;
                            B = l ? v[T - 1] : 0 == p[f + 1] ? v[T + 2] : Math.atan2(C, S), B -= Math.atan2(P, w) - A / 180 * Math.PI, N && (L = Math.cos(B), R = Math.sin(B), I += ((x = y.length) * (L * w - R * P) - S) * a, b += (x * (R * w + L * P) - C) * a), B > Math.PI ? B -= 2 * Math.PI : B < -Math.PI && (B += 2 * Math.PI), B *= a, L = Math.cos(B), R = Math.sin(B), y.resultMatrix.a = L * w - R * P, y.resultMatrix.c = L * k - R * U, y.resultMatrix.b = R * w + L * P, y.resultMatrix.d = R * k + L * U;
                        }
                    }
                }
                ...
                if (null != l) {
                    ...
                    var N = A.tx,
                        ...
                        F = A.c,
                        w = A.d;
                    for (h && (w *= h.d), _ = i, f = r; f < a; _ += 2, f += 2) g = u[_], D = u[_ + 1], s[f] = g * S + D * C + N, s[f + 1] = -(g * F + D * w + T);
                }
                ...
                var I = this._curves,
                    ...
                    V = NaN,
                    O = 0;
                for (l = 0, O = 2; l < d; l++, O += 6) N = _[O], T = _[O + 1], S = _[O + 2], C = _[O + 3], L = 2 * (k = .1875 * (b - 2 * N + S)) + (U = .09375 * (3 * (N - S) - b + (F = _[O + 4]))), R = 2 * (P = .1875 * (A - 2 * T + C)) + (B = .09375 * (3 * (T - C) - A + (w = _[O + 5]))), E = .75 * (N - b) + k + .16666667 * U, V = .75 * (T - A) + P + .16666667 * B, m += Math.sqrt(E * E + V * V), E += L, V += R, L += U, R += B, m += Math.sqrt(E * E + V * V), E += L, V += R, m += Math.sqrt(E * E + V * V), E += L + U, V += R + B, m += Math.sqrt(E * E + V * V), I[l] = m, b = F, A = w;
                if (r && (u *= m), n)
                    for (l = 0; l < a; l++) c[l] *= m;
                ...
                for (W = x = y = l = 0; l < a; l++, y += 3)
                    ...
                    if (x != f) {
                        var X = 6 * (f = x);
                        for (b = _[X], A = _[X + 1], N = _[X + 2], T = _[X + 3], S = _[X + 4], C = _[X + 5], L = 2 * (k = .03 * (b - 2 * N + S)) + (U = .006 * (3 * (N - S) - b + (F = _[X + 6]))), R = 2 * (P = .03 * (A - 2 * T + C)) + (B = .006 * (3 * (T - C) - A + (w = _[X + 7]))), E = .3 * (N - b) + k + .16666667 * U, V = .3 * (T - A) + P + .16666667 * B, Y = Math.sqrt(E * E + V * V), K[0] = Y, X = 1; X < 8; X++) E += L, V += R, L += U, R += B, Y += Math.sqrt(E * E + V * V), K[X] = Y;
                        E += L, V += R, Y += Math.sqrt(E * E + V * V), K[8] = Y, E += L + U, V += R + B, Y += Math.sqrt(E * E + V * V), K[9] = Y, W = 0;
                    }
                    for (g *= Y;; W++)
                        if (!((M = K[W]) < g)) {
        ...
        Wt = function() {
            ...
            return t.setTempMatrix = function(t) {
                ...
                var e;
                if (this.rotation = this.transform.skX, t) e = this.resultTransform.getMatrix(), Ft.mul(e, t, this.resultMatrix), this.resultRotation = this.rotation;
                else if (this.resultRotation = this.rotation + this.parentBone.resultRotation, this.parentBone)
                    if (this.inheritRotation && this.inheritScale) e = this.resultTransform.getMatrix(), Ft.mul(e, this.parentBone.resultMatrix, this.resultMatrix);
                    else {
        ...
        N = function(t) {
            ...
            return st.imps(i, {
                ...
                this._currentTime = 0, this._currentFrameTime = 0, this._elapsedPlaybackTime = 0, this.playbackRate = e, this._overallDuration = i, this._playStart = a, this._playEnd = s, this._paused = !1, this._currentAnimationClipIndex = t, this._currentKeyframeIndex = 0, this._startUpdateLoopCount = d.loopCount, this.event("played"), this._calculatePlayDuration(), this._update(0);
        ...
        T = function(t) {
            ...
            return a(e, "laya.ani.bone.canvasmesh.SkinMeshForGraphic", x), e.prototype.init2 = function(t, e, i, a) {
                ...
                var s = e || [0, 1, 3, 3, 1, 2];
                this.texture = t, m.isWebGL ? (this.indexes = new Uint16Array(s), this.vertices = new Float32Array(i), this.uvs = new Float32Array(a)) : (this.indexes = s, this.vertices = i, this.uvs = a);
            }, e;
        }(),
        P = function(t) {
            function D() {
            ...
            return e.parse = function(t) {
                ...
                a[e] = a[0];
                for (var s = 0; s < e; s++)
                    for (var r = a[s], n = 0; n < i; n++) r.dData[n] = 0 === r.duration ? 0 : (a[s + 1].data[n] - r.data[n]) / r.duration, r.nextData[n] = a[s + 1].data[n];
                a.length--;
                ...
                return void 0 === u && (u = 0), i[a] = s[e] + (l[e] - s[e]) * A.getBezierRate(r / h, o[u], o[u + 1], o[u + 2], o[u + 3]), 5;
            }, D._BezierInterpolation_7 = function(t, e, i, a, s, r, n, h, l, o, u) {
                return void 0 === u && (u = 0), i[a] = o[u + 4] + o[u + 5] * A.getBezierRate((.001 * r + o[u + 6]) / o[u + 7], o[u], o[u + 1], o[u + 2], o[u + 3]), 9;
            }], D;
        }(),
        S = (function(e) {
            function f(t) {
            ...
            return t.init = function(t, e) {
                ...
                if (this._yReverseMatrix = t.yReverseMatrix, this._aniMode = e, this._templet = t, this._player = new N(), this._player.cacheFrameRate = t.rate, this._player.templet = t, this._player.play(), this._parseSrcBoneMatrix(), this._boneList = t.mBoneArr, this._rootBone = t.mRootBone, this._aniSectionDic = t.aniSectionDic, 0 < t.ikArr.length)
                    for (this._ikArr = [], r = 0, n = t.ikArr.length; r < n; r++) this._ikArr.push(new D(t.ikArr[r], this._boneList));
                if (0 < t.pathArr.length)
                    for (null == this._pathDic && (this._pathDic = {}), r = 0, n = t.pathArr.length; r < n; r++) i = t.pathArr[r], a = new b(i, this._boneList), (s = this._boneSlotDic[i.name]) && ((a = new b(i, this._boneList)).target = s), this._pathDic[i.name] = a;
                if (0 < t.tfArr.length)
                ...
                for (f = u[_ = 0]; _ < m; _++) {
                    ...
                    l = this._templet.srcBoneMatrixArr[_], x.scX = l.scX * y[c++], x.skX = l.skX + y[c++], x.skY = l.skY + y[c++], x.scY = l.scY * y[c++], x.x = l.x + y[c++], x.y = l.y + y[c++], 8 === this._templet.tMatrixDataLen && (x.skewX = l.skewX + y[c++], x.skewY = l.skewY + y[c++]);
                }
                var g, D = {},
                    v = {};
                ...
                if (this._rootBone.update(this._yReverseMatrix || Ft.TEMP.identity()), this._ikArr)
                    for (_ = 0, f = this._ikArr.length; _ < f; _++) I = this._ikArr[_], b.hasOwnProperty(I.name) && (I.bendDirection = b[I.name]), A.hasOwnProperty(I.name) && (I.mix = A[I.name]), I.apply();
                if (this._pathDic)
                ...
                for (_ = 0, d = this._boneList.length; _ < d; _++)
                    if (o = this._boneList[_], h = this._bindBoneBoneSlotDic[o.name], o.resultMatrix.copyTo(this._boneMatrixArray[_]), h)
                        for (p = 0, f = h.length; p < f; p++)(n = h[p]) && n.setParentMatrix(o.resultMatrix);
                var T, S, C, F, w = {},
                    k = this._templet.deformAniArr;
                if (k && 0 < k.length) {
                    if (this._lastAniClipIndex != this._aniClipIndex)
                        for (this._lastAniClipIndex = this._aniClipIndex, _ = 0, f = this._boneSlotArray.length; _ < f; _++)(n = this._boneSlotArray[_]).deformData = null;
                    var P, U = k[this._aniClipIndex];
                    for (P in T = U.default, this._setDeform(T, w, this._boneSlotArray, i), U) "default" != P && P != this._skinName && (T = U[P], this._setDeform(T, w, this._boneSlotArray, i));
                    T = U[this._skinName], this._setDeform(T, w, this._boneSlotArray, i);
                }
                if (this._drawOrder)
                    for (_ = 0, f = this._drawOrder.length; _ < f; _++) S = D[(n = this._boneSlotArray[this._drawOrder[_]]).name], C = v[n.name], isNaN(C), isNaN(S) || -2 == S || (this._templet.attachmentNames ? n.showDisplayByName(this._templet.attachmentNames[S]) : n.showDisplayByIndex(S)), w[this._drawOrder[_]] ? (F = w[this._drawOrder[_]], n.currDisplayData && F[n.currDisplayData.attachmentName] ? n.deformData = F[n.currDisplayData.attachmentName] : n.deformData = null) : n.deformData = null, isNaN(C) ? n.draw(s, this._boneMatrixArray, 2 == this._aniMode) : n.draw(s, this._boneMatrixArray, 2 == this._aniMode, C), isNaN(C);
                else
                    for (_ = 0, f = this._boneSlotArray.length; _ < f; _++) S = D[(n = this._boneSlotArray[_]).name], C = v[n.name], isNaN(C), isNaN(S) || -2 == S || (this._templet.attachmentNames ? n.showDisplayByName(this._templet.attachmentNames[S]) : n.showDisplayByIndex(S)), w[_] ? (F = w[_], n.currDisplayData && F[n.currDisplayData.attachmentName] ? n.deformData = F[n.currDisplayData.attachmentName] : n.deformData = null) : n.deformData = null, isNaN(C) ? n.draw(s, this._boneMatrixArray, 2 == this._aniMode) : n.draw(s, this._boneMatrixArray, 2 == this._aniMode, C), isNaN(C);
                0 == this._aniMode ? (this._templet.setGrahicsDataWithCache(this._aniClipIndex, t, s), this._checkIsAllParsed(this._aniClipIndex)) : 1 == this._aniMode && this._setGrahicsDataWithCache(this._aniClipIndex, t, s);
        ...
        C = function(e) {
            ...
            return t.loadAni = function(t) {
                ...
                void 0 === i && (i = 30), !this._path && this._relativeUrl && (this._path = this._relativeUrl.slice(0, this._relativeUrl.lastIndexOf("/")) + "/"), !this._path && this.url && (this._path = this.url.slice(0, this.url.lastIndexOf("/")) + "/"), this._mainTexture = t, this._mainTexture && m.isWebGL && t.bitmap && (t.bitmap.enableMerageInAtlas = !1), this._rate = i, this.parse(e);
            }, t.buildArmature = function(t) {
                return void 0 === t && (t = 0), new S(this, t);
            }, t.parse = function(t) {
                e.prototype.parse.call(this, t), this.event("loaded", this), this._aniVersion != s.LAYA_ANIMATION_VISION && console.log("[Error] 版本不一致，请使用IDE版本配套的重新导出" + this._aniVersion + "->" + s.LAYA_ANIMATION_VISION), this._mainTexture ? this._parsePublicExtData() : this._parseTexturePath();
                ...
                for (var t, e, i = 0, a = this._loadList.length; i < a; i++) e = this._loadList[i], t = this._textureDic[e] = l.getRes(e), m.isWebGL && t && t.bitmap && (t.bitmap.enableMerageInAtlas = !1);
                ...
                var T, S = l.getInt16(),
                    C = {};
                for (t = 0; t < S; t++) M = new Wt(), 0 == t ? T = M : M.root = T, M.d = r ? -1 : 1, b = l.readUTFString(), A = l.readUTFString(), M.length = l.getFloat32(), 1 == l.getByte() && (M.inheritRotation = !1), 1 == l.getByte() && (M.inheritScale = !1), M.name = b, A && ((I = C[A]) ? I.addChild(M) : this.mRootBone = M), C[b] = M, this.mBoneArr.push(M);
                ...
                var B, L = l.getUint16(),
                    R = 0;
                for (t = 0; t < L; t++) {
                    for (w = new Gt(), R = l.getUint16(), e = 0; e < R; e++) w.boneNames.push(l.readUTFString()), w.boneIndexs.push(l.getInt16());
                    w.name = l.readUTFString(), w.targetBoneName = l.readUTFString(), w.targetBoneIndex = l.getInt16(), w.bendDirection = l.getFloat32(), w.mix = l.getFloat32(), w.isSpine = r, this.ikArr.push(w);
                }
                var E, V = l.getUint16(),
                    O = 0;
                for (t = 0; t < V; t++) {
                ...
                for (t = 0; t < J; t++) {
                    ...
                    for (var it = 0; it < tt; it++)
                        for ((W = new Rt()).skinName = l.getUTFString(), et[W.skinName] = W, H = l.getInt16(), e = 0; e < H; e++)
                            for (X = new Ut(), W.deformSlotDataList.push(X), Z = l.getInt16(), i = 0; i < Z; i++)
                                for (G = new Vt(), X.deformSlotDisplayList.push(G), G.slotIndex = l.getInt16(), G.attachment = l.getUTFString(), Q = l.getInt16(), a = 0; a < Q; a++)
                                    for (1 == l.getByte() ? G.tweenKeyList.push(!0) : G.tweenKeyList.push(!1), $ = l.getFloat32(), G.timeList.push($), z = [], G.vectices.push(z), j = l.getInt16(), s = 0; s < j; s++) z.push(l.getFloat32());
                }
                ...
                var lt, ot = l.getInt16(),
                    ut = 0;
                for (t = 0; t < ot; t++) {
                    for (ut = l.getInt16(), st = [], e = 0; e < ut; e++)(lt = new Xt()).name = l.getUTFString(), lt.intValue = l.getInt32(), lt.floatValue = l.getFloat32(), lt.stringValue = l.getUTFString(), lt.time = l.getFloat32(), st.push(lt);
                ...
                this.skinSlotDisplayDataArr.length = 0, this.url && delete s.TEMPLET_DICTIONARY[this.url], laya.resource.Resource.prototype.destroy.call(this);
            }, t.getAniNameByIndex = function(t) {
