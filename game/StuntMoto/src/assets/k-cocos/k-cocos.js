(function() {
    ...
    e.director.calculateDeltaTime = function(e) {
        ...
        setMoveSpeed: function(e, t) {
            e && "object" == typeof e ? (this.speed_x = e.x || 0, this.speed_y = e.y || 0) : (this.speed_x = e || 0, this.speed_y = t || 0)
        },
        getAccelerate: function() {
            return new e.Vec2(this.accelerate_x, this.accelerate_y)
        },
        setAccelerate: function(e, t) {
            e && "object" == typeof e ? (this.accelerate_x = e.x || 0, this.accelerate_y = e.y || 0) : (this.accelerate_x = e || 0, this.accelerate_y = t || 0)
        },
        setDestination: function(e, t, i) {
            ...
            var s = this.aimPos_x - this.node.x,
                ...
                r = s / a,
                h = n / a;
            this.setMoveSpeed(t * r, t * h), this.setAccelerate(i * r, i * h), this.hasAim = !0
        },
        update: function(e) {
            if (this.speed_x += this.accelerate_x, this.speed_y += this.accelerate_y, this.hasAim) {
                ...
                (t * s < 0 || i * n < 0) && (this.hasAim = !1, this.node.x = this.aimPos_x, this.node.y = this.aimPos_y, this.setAccelerate(0, 0), this.setMoveSpeed(0, 0))
            } else this.node.x += this.speed_x * e, this.node.y += this.speed_y * e
        }
    }), e.kNode = function(t) {
        return t.kTag = 0, t.kInfo = "init", t._kState = "init", Object.defineProperties(t, {
            kState: {
                get() {
                    return this._kState
                },
